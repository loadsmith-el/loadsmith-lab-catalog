# AI Agent Guidelines — loadsmith-lab-canonical-catalog
...
These are **operating instructions only** — for what this repo is and how a
case/bundle is structured, read [README.md](../README.md) and the
[loadsmith-lab docs](../../loadsmith-lab/docs/src), or the source itself.
